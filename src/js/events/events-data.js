// Auto Generated on 2025-06-20T13:25:02.939Z
 module.exports = [
  {
    "event": {
      "title": "NCSG JUNE 2025 | AI Meets Cybersecurity: How to Build Security Tooling",
      "description": "**AI Meets Cybersecurity: How to Build Security Tools with LLMs**\n\nEver wondered how you can use AI like Claude, ChatGPT to create your own cybersecurity tools? Join us for a fun and eye-opening chat about using Large Language Models (LLMs) to build lightweight security solutions that actually work (most the time, kind of)!\n\n**What's in it for you:**\n\n* Discover how everyday AI tools can become your cybersecurity sidekick\n* See real examples of clever security tools built with AI\n* Learn why this approach is gaining traction (and where it might trip you up)\n* Get practical tips you can actually use\n* Understand the good, the bad, and the \"O RLY?\" of AI-powered security\n\nThis session is perfect for anyone curious about where technology is heading. Whether you're just getting into IT, studying cybersecurity, already deep in the tech world, or a business owner trying to make sense of all this AI buzz – you'll walk away with real insights and maybe even some inspiration for your next project.\n\n**Meet Your Speaker:** Andrew Stace is the kind of guy who gets excited about both the latest AI breakthroughs and the nitty-gritty of keeping systems secure. As Lead Security Capabilities Specialist at nib Group, he's hands-on with the challenges we all face in today's digital world. Plus, he's (allegedly) great at explaining complex stuff without making your head spin\\*.\n\n**Come along if you're:**\n\n* Curious about IT and want to learn something new\n* A student exploring what's possible in tech\n* A seasoned pro looking for fresh perspectives\n* Already in cybersecurity and wondering about AI's role\n* A business owner who wants to understand what all this means for you\n\n**Event details:**\n\nVenue: 16 Honeysuckle Drive, Newcastle (The University of Newcastle 'Q Building') - second floor\n\nFood: PIZZAS Provided, please inform us of dietary requirements when RSVPing\n\nDrink: Non-alcoholic provided\n\n**Getting there/parking/public transport:**\n\n* Event location is [here](https://goo.gl/maps/rCqoDx8MbjqyeHTMA)\n* Please try and get in the door before 6:10pm. We check occasionally but you might get stuck outside in the cold for a while.\n* The [car park behind the building](https://goo.gl/maps/FzNNQfbAxxW38GNr7) is free after 5PM, and generally has plenty of room.\n* The closest public transport point is [Honeysuckle Light Rail Station](https://goo.gl/maps/3P2BpkiMaCeZ8isk9), which will take you to Newcastle Interchange and beyond every \\~7min or so. Walk along Honeysuckle Drive for a better-lit pathway.\n\n**The rest:**\n\nIf you’re experiencing any symptoms representative of COVID-19, please don’t attend. We’ll miss you, but the health/safety of attendees is paramount.\n\nNCSG is a community group determined to improve and uplift the Newcastle cybersecurity community. We meet monthly (on the last Wednesday of each month) and have a bunch of interesting speakers, from local legends to heavy hitters in the enterprise world.\n\n**Want to learn more?** Be sure to follow us on [LinkedIn](https://www.linkedin.com/company/newcastlecybersecuritygroup/) or visit newwwie.com, join the community and come and chat in the #security channel.\n\n**Keen on speaking? Reach out at the event, or message us here.**",
      "dateTime": "2025-06-25T18:00+10:00",
      "eventUrl": "https://www.meetup.com/newcastle-cyber-security-group/events/307362823",
      "going": 27,
      "maxTickets": 0,
      "duration": "PT3H",
      "imageUrl": "https://secure-content.meetupstatic.com/images/classic-events/528603692/676x380.webp",
      "venue": {
